...
test_1()->
 ...
 %% N4 -----------------------------------------------------------------------------------------
   ...
   % N3='c3@c50',
    ...
    locked=rpc:call(N1,db_lock,try_lock,[schedule,3000],5000),
    locked=rpc:call(N2,db_lock,try_lock,[schedule,3000],5000),
    locked=rpc:call(N31,db_lock,try_lock,[schedule,3000],5000),
    timer:sleep(3000),
    {ok,TransActionsId_41}=rpc:call(N31,db_lock,try_lock,[schedule,1000],5000),
    locked=rpc:call(N1,db_lock,try_lock,[schedule,1000],5000),
    locked=rpc:call(N2,db_lock,try_lock,[schedule,1000],5000),
    locked=rpc:call(N31,db_lock,try_lock,[schedule,1000],5000),
    ok=rpc:call(N31,db_lock,unlock,[schedule,TransActionsId_41],5000),
